...
<script>
import HeaderKieyori from "@/components/HeaderKieyori.vue";
import FooterKieyori from "@/components/FooterKieyori.vue";
import RelatedKieyori from "@/components/RelatedKieyori.vue";
